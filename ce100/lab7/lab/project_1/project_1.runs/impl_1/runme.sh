...
HD_PWD='C:/Users/ghchen/Desktop/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topoffmydick.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topoffmydick.tcl -notrace
