...
HD_PWD='C:/Users/ghchen/Desktop/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topoffmydick.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topoffmydick.tcl
