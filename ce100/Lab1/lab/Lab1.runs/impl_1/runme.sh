...
HD_PWD='C:/Users/ghchen/Lab1/Lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab1Shit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab1Shit.tcl -notrace
