...
HD_PWD='C:/Users/ghchen/Desktop/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topdawg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topdawg.tcl
