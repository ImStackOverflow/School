...
HD_PWD='C:/Users/ghchen/Desktop/lab6/lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topdawg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topdawg.tcl -notrace
