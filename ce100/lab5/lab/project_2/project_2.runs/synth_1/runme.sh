...
HD_PWD='C:/Users/ghchen/Desktop/lab5/project_2/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log topgun.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source topgun.tcl
