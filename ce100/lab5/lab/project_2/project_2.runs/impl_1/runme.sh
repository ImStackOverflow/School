...
HD_PWD='C:/Users/ghchen/Desktop/lab5/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topgun.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topgun.tcl -notrace
